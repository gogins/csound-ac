...
sox_spectrogram_command = '''sox -S "%s" -n spectrogram -x 1200 -Y 1200 -o "%s" -t"%s" -c"%s"''' % (master_filename, spectrogram_filename, label, str_copyright + ' (%s' % publisher)
print('sox_spectrogram_command:', sox_spectrogram_command)
os.system(sox_spectrogram_command)
resize_spectrogram_command = '''magick "%s" -resize 1400x1400! "%s-resized.png"''' % (spectrogram_filename, spectrogram_filename)
os.system(resize_spectrogram_command)
print('resize_spectrogram_command:', resize_spectrogram_command)
