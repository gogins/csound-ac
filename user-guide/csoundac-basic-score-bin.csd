...
# It is not necessary to compile the .csd file because Csound has already done 
# that.
...
# Write the entire Csound score generated by CsoundAC to the temporary file in 
# one go.
