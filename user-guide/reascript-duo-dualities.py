...
gcg.setAxiom('pcs1 R66 WC V+11 WC xV-2 WC a3 dd a4 dd L*2 D*3.5 pcs1 T+5 zV+17 a3 D/3.55 L/2 arp1 dd K D*1.875 L/4 a4 arp2 dd dd')
gcg.addRule( 'pcs1', 'P(0,4,7,11,14) ') 
 
gcg.addRule('a3',   'V+11 a3k a3q a3 a3 ') 
gcg.addRule('a3k',  'K  arp WV WC ')
gcg.addRule('a3q',  'Q7     WV K D/1.245 WV arp1 D/1.25 WC a4q D*1.25 zV+2 D*1.25 V+5 WC WC ')
...
gcg.addRule('arp',  'T+6 V+17 WC V+5 WC xV-16 WC V-9 T-7') 
