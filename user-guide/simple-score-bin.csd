...
endin
gk_Tambourine_level chnexport "gk_Tambourine_level", 3
gk_Tambourine_level init 0
gk_Tambourine_space_left_to_right chnexport "gk_Tambourine_space_left_to_right", 3
gk_Tambourine_space_left_to_right init .5

gi_Tambourine_idamp init .07 ;p4
gi_Tambourine_idettack init 1; .01
gi_Tambourine_ifreq3 init 4600
...
k_gain = ampdb(gk_Tambourine_level)
if p7 == 0 then
k_space_left_to_right = gk_Tambourine_space_left_to_right
endif
k_space_bottom_to_top = p8
i_phase = p9
...
; ares    tambourine kamp, gi_Tambourine_idettack [, inum] [, gi_Tambourine_idamp] [, imaxshake] [, ifreq] [, ifreq1] [, ifreq2]
a_signal  tambourine .8,    gi_Tambourine_idettack,   30,     gi_Tambourine_idamp,     0.4, i_frequency, i_frequency * 1.5, gi_Tambourine_ifreq3
...
with open(sys.argv[1], 'w') as scofile:
  for i in range(100):
    scofile.write(f"i {1 + (i % 8)} {i / 4} 5 {36 + (i % 60)} 60 0 0 0 0\n")
</CsScore>
</CsoundSynthesizer>
