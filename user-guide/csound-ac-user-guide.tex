...
CsoundAC is a class library and software toolkit designed to support the algorithmic composition of music. CsoundAC has C++, Python, and JavaScript application programming interfaces (APIs). This \emph{\textbf{Guide}} is based on on the Python interface.

As the name suggests, CsoundAC interfaces easily with \href{https://csound.com/}{ Csound}. However, CsoundAC can also be used with any other computer music system that supports Python scripting, including digital audio workstations (DAWs) such as \href{https://www.reaper.fm/}{Reaper}.
...
Test your installation by running the correct version of Python and importing CsoundAC and GeneralizedContextualGroup. There should be no error.
