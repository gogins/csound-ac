...
For insight into the code, open the examples in an editor and read them in order, there are many explanatory comments.
...
These three examples re-create the three basic examples above, changing them only to generate the ascending chromatic scale as a CsoundAC ScoreNde object, and to render that using CsoundAC's integration with Csound.
...
These three examples are more complex, and demonstrate typical uses of CsoundAC. Two implementations are provided for each example, as standalone Python and as Python ReaScript for Reaper.
