...
On macOS, use the Terminal app to gain access to the macOS command line.   Add the following lines to your \lstinline|.zprofile| script:

\begin{lstlisting}
export DYLD_LIBRARY_PATH=~/csound-ac-0.5.0-Darwin/lib:$DYLD_LIBRARY_PATH
export PYTHONPATH=~/csound-ac-0.5.0-lDarwin/lsite-packages:$PYTHONPATH
\end{lstlisting}

Then in your home directory, execute \lstinline|source .zprofile|.

On Linux add the following lines to your \lstinline|.profile| script:

\begin{lstlisting}
export LD_LIBRARY_PATH=~/csound-ac-0.5.0-linux/lib:$LD_LIBRARY_PATH
export PYTHONPATH=~/csound-ac-0.5.0-linux/lsite-packages:$PYTHONPATH
\end{lstlisting}
