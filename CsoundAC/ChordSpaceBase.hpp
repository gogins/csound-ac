...
#define CHORD_SPACE_DEBUG                \
    ...
    public:
         ...
         */
        virtual Chord eI(int sector = 0) const;
        /**
         ...
         */
        virtual Chord eOPI(int sector = 0) const;
        /**
         * Returns the equivalent of the chord within a fundamental
         ...
         * from another sector is returned.
         */
        virtual Chord eOPT(int sector = 0) const;
        /**
         * Returns the equivalent of the chord within a fundamental
         ...
         * returned.
         */
        virtual Chord eOPTT(double g = 1., int sector = 0) const;
        /**
         * Returns the equivalent of the chord within a fundamental
         ...
         */
        virtual Chord eOPTI(int sector = 0) const;
        /**
         * Returns the equivalent of the chord within a fundamental
         * domain of range, permutational, transpositional, and inversional
         ...
         */
        virtual Chord eOPTTI(double g = 1., int sector = 0) const;
        /**
         * Returns the equivalent of the chord within the representative
         ...
         * from another sector is returned.
         */
        virtual Chord eRPI(double range, int sector = 0) const;
        /**
         * Returns the equivalent of the chord within a fundamental
         ...
         * from another sector is returned.
         */
        virtual Chord eRPT(double range, int sector = 0) const;
        /**
         * Returns the equivalent of the chord within a fundamental
         ...
         * is returned.
         */
        virtual Chord eRPTT(double range, double g = 1., int sector = 0) const;
        /**
         ...
         * from another sector is returned. 
         */
        virtual Chord eRPTI(double range, int sector = 0) const;
        /**
         * Returns the equivalent of the chord within a fundamental
         * domain of range, permutational, transpositional, and inversional
         * equivalence. If the equivalent is not found in the indicated sector, an equivalent
         * from another sector is returned.
         */
        virtual Chord eRPTTI(double range, double g = 1., int sector = 0) const;
        /**
         * Returns the equivalent of the chord within a fundamental
         * domain of range, permutational, transpositional, and inversional
         ...
         */
        virtual bool is_opt_sector(int sector = 0) const;
        /**
         * Returns whether or not this chord lies within the indicated sector of
         * the cyclical region of OPTI fundamental domains.
         */
        virtual bool is_opti_sector(int sector = 0) const;
        /**
         * Returns whether the chord is within a fundamental domain of inversional
         * equivalence.
         */
        virtual bool iseI_chord(Chord *inverse, int sector = 0) const;
        virtual bool iseI(int sector = 0) const;
        /**
         ...
         * permutational, and inversional equivalence.
         */
        virtual bool iseRPI(double range, int sector = 0) const;
        /**
         * Returns whether the chord is within a fundamental domain of range,
         * permutational, and transpositional equivalence.
         */
        virtual bool iseRPT(double range, int sector = 0) const;
        /**
         * Returns whether the chord is within a fundamental domain of range,
         * permutational, and transpositional equivalence in the equal temperament
         * generated by g.
         */
        virtual bool iseRPTT(double range, double g = 1., int sector = 0) const;
        /**
         * Returns whether the chord is within a fundamental domain of range,
         * permutational, transpositional, and inversional equivalence.
         */
        virtual bool iseRPTI(double range, int sector = 0) const;
        /**
         * Returns whether the chord is within a fundamental domain of range,
         * permutational, transpositional, and inversional equivalence in the '
         * equal temperament generated by g.
         */
        virtual bool iseRPTTI(double range, double g = 1., int sector = 0) const;
        /**
         * Returns whether the chord is within the representative fundamental
         * domain of range and transpositional equivalence.
         */
         ...
         */
        virtual bool self_inverse(int sector = 0) const;
        /**
