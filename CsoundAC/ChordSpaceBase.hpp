...
#define CHORD_SPACE_DEBUG                \
    ...
    public:
         ...
         * equivalence. If the equivalent is not found in the indicated sector,
         * an equivalent from another sector is returned.
         */
        virtual Chord eOPTI(int sector = CANONICAL_MODE) const;
        /**
         * Returns the equivalent of the chord within a fundamental
         * domain of range, permutational, transpositional, and inversional
         * equivalence but in the equal temperament generated by g. If the
         * equivalent is not found in the indicated sector, an equivalent from
         * another sector is returned.
         */
        virtual Chord eOPTTI(double g = 1., int sector = CANONICAL_MODE) const;
        /**
         * Returns the equivalent of the chord within the representative
         * fundamental domain of octave and transpositional equivalence. If the
         * equivalent is not found in the indicated sector, an equivalent from
         * another sector is returned.
         */
        virtual Chord eOT(int sector = CANONICAL_MODE) const;
        /**
         * Returns the equivalent of the chord within a fundamental domain of
         ...
         */
        virtual Chord eR(double range, int sector = CANONICAL_MODE) const;
        /**
         * Returns the equivalent of the chord within the representative fundamental
         * domain of range and permutational equivalence.
         */
        virtual Chord eRP(double range, int sector = CANONICAL_MODE) const;
        /**
         * Returns the equivalent of the chord within the representative fundamental
         * domain of range and transpositional equivalence.
         */
        virtual Chord eRT(double range, int sector = CANONICAL_MODE) const;
        /**
         * Returns the equivalent of the chord within a fundamental
         ...
         * from another sector is returned.
         */
        virtual Chord eRPT(double range, int sector = CANONICAL_MODE) const;
        /**
         * Returns the equivalent of the chord within a fundamental
         * domain of range, permutational, and transpositional equivalence, in the
         * equal temperament generated by g; the same as chord type. If the equivalent
         * is not found in the indicated sector, an equivalent from another sector
         * is returned.
         */
        virtual Chord eRPTT(double range, double g = 1., int sector = CANONICAL_MODE) const;
        /**
         * Returns all equivalents of the chord within all fundamental
         * domains of range, permutational, and transpositional equivalence. If the
         * equivalent is not found in the indicated sector, an equivalent from
         * another sector is returned.
         */
         ...
         * from another sector is returned.
         */
        virtual Chord eRPTTI(double range, double g = 1., int sector = CANONICAL_MODE) const;
        /**
         * Returns the equivalent of the chord within a fundamental
         * domain of range, permutational, transpositional, and inversional
         ...
         * class.
         */
        virtual Chord eT(int sector = CANONICAL_MODE) const;
        /**
         * Returns the equivalent of the chord within the representative fundamental
         ...
         */
        virtual Chord eTT(double g = 1., int sector = CANONICAL_MODE) const;
        /**
         ...
         */
        virtual std::string information_debug(int sector) const;
        /**
         * Print much information about the chord including whether it is within
         * important equivalence classes, or what its equivalents would be.
         */
        virtual std::string information_sector(int sector) const;
        /**
         * Print much information about the chord including whether it is within
         * important equivalence classes, or what its equivalents would be.
         */
         ...
         */
        virtual bool iseR(double range_, int sector = CANONICAL_MODE) const;
        /**
         * Returns whether the chord is within the representative fundamental
         * domain of range and permutational equivalence.
         */
        virtual bool iseRP(double range, int sector = CANONICAL_MODE) const;
        /**
         * Returns whether the chord is within a fundamental domain of range,
         * permutational, and inversional equivalence.
         */
        virtual bool iseRPI(double range, int sector = CANONICAL_MODE) const;
        /**
         * Returns whether the chord is within a fundamental domain of range,
         * permutational, and transpositional equivalence.
         */
        virtual bool iseRPT(double range, int sector = CANONICAL_MODE) const;
        /**
         * Returns whether the chord is within a fundamental domain of range,
         * permutational, and transpositional equivalence in the equal temperament
         * generated by g.
         */
        virtual bool iseRPTT(double range, double g = 1., int sector = CANONICAL_MODE) const;
        /**
         * Returns whether the chord is within a fundamental domain of range,
         * permutational, transpositional, and inversional equivalence.
         */
        virtual bool iseRPTI(double range, int sector = CANONICAL_MODE) const;
        /**
         * Returns whether the chord is within a fundamental domain of range,
         * permutational, transpositional, and inversional equivalence in the '
         * equal temperament generated by g.
         */
        virtual bool iseRPTTI(double range, double g = 1., int sector = CANONICAL_MODE) const;
        /**
         * Returns whether the chord is within the representative fundamental
         * domain of range and transpositional equivalence.
         */
         ...
         */
        virtual bool iseRTT(double range, double g = 1., int sector = CANONICAL_MODE) const
        {
            if (iseR(range, sector) == false)
            {
                return false;
            }
            if (iseTT(g, sector) == false)
            {
                return false;
            }
            return true;
         ...
         */
        virtual bool iseT(int sector = CANONICAL_MODE) const;
        /**
         * Returns whether the chord is within the representative fundamental
         * domain of transpositional equivalence in the equal temperament
         * generated by g.
         */
        virtual bool iseTT(double g = 1., int sector = CANONICAL_MODE) const;
         ...
         */
        virtual bool self_inverse(int sector = CANONICAL_MODE) const;
        /**
         ...
         */
        virtual Chord reflect(int sector) const;
    ...
    SILENCE_PUBLIC std::vector<Chord> fundamentalDomainByPredicate(int voiceN, double range, double g = 1., int sector = CANONICAL_MODE, bool printme = false);
     ...
     */
    template <int EQUIVALENCE_RELATION>
    SILENCE_PUBLIC std::vector<Chord> fundamentalDomainByTransformation(int voiceN, double range, double g = 1., int sector = CANONICAL_MODE);
    ...
    //~ SILENCE_PUBLIC HyperplaneEquation hyperplane_equation_from_random_inversion_flat(int dimensions, bool transpositional_equivalence = true, int sector = 1);
    ...
    SILENCE_PUBLIC bool predicate(const Chord &chord,
                                  double range, double g, int sector = CANONICAL_MODE);
    ...
    SILENCE_PUBLIC Chord reflect_in_inversion_flat(const Chord &chord, int sector);
    ...
    template <int ER>
    inline SILENCE_PUBLIC Chord equate(const Chord &, double, double, int);

    template <>
    inline SILENCE_PUBLIC Chord equate<EQUIVALENCE_RELATION_T>(const Chord &, double, double, int);
    template <>
    inline SILENCE_PUBLIC Chord equate<EQUIVALENCE_RELATION_Tg>(const Chord &, double, double, int);
    template <>
    inline SILENCE_PUBLIC Chord equate<EQUIVALENCE_RELATION_RPT>(const Chord &, double, double, int);
    template <>
    inline SILENCE_PUBLIC Chord equate<EQUIVALENCE_RELATION_RPTg>(const Chord &, double, double, int);
    template <>
    inline SILENCE_PUBLIC Chord equate<EQUIVALENCE_RELATION_RPTI>(const Chord &, double, double, int);
    template <>
    inline SILENCE_PUBLIC Chord equate<EQUIVALENCE_RELATION_RPTgI>(const Chord &, double, double, int);
    template <>
    ...
    inline bool Chord::self_inverse(int sector) const
    {
        auto inverse = reflect_in_inversion_flat(*this, sector);
        if (*this == inverse)
        {
            return true;
        }
    ...
    inline bool Chord::iseR(double range_, int sector) const
    {
        return predicate<EQUIVALENCE_RELATION_R>(*this, range_, 1.0, sector);
    }
    ...
    */
    template <>
    inline SILENCE_PUBLIC Chord equate<EQUIVALENCE_RELATION_R>(const Chord &chord, double range_, double g, int sector)
    {
        if (sector >= 0)
        {
            CHORD_SPACE_DEBUG("equate<EQUIVALENCE_RELATION_R>: sector %d not supported—using canonical mode\n", sector);
    ...
    inline Chord Chord::eR(double range, int sector) const
    {
        return csound::equate<EQUIVALENCE_RELATION_R>(*this, range, 1.0, sector);
    }
    ...
    inline bool Chord::iseT(int sector) const
    {
        return predicate<EQUIVALENCE_RELATION_T>(*this, OCTAVE(), 1., sector);
    }
    ...
    inline Chord Chord::eT(int sector) const
    {
        return csound::equate<EQUIVALENCE_RELATION_T>(*this, OCTAVE(), 1.0, sector);
    }
    ...
    inline Chord Chord::eTT(double g, int sector) const
    {
        return csound::equate<EQUIVALENCE_RELATION_Tg>(*this, OCTAVE(), g, sector);
    }

    inline bool Chord::iseTT(double g, int sector) const
    {
        return predicate<EQUIVALENCE_RELATION_Tg>(*this, OCTAVE(), g, sector);
    }
    ...
    inline SILENCE_PUBLIC bool predicate<EQUIVALENCE_RELATION_I>(const Chord &chord, double range, double g, int sector)
    {
        ...
        if (sector < 0)
        {
            ...
            const Chord rep = equate<EQUIVALENCE_RELATION_I>(chord, OCTAVE(), 1.0, CANONICAL_MODE);
        ...
        // Geometric mode: "minor half" selection within the OPT simplex for this sector.
        // If the chord is exactly on the inversion flat (self-inverse), it is admissible.
        ...
        if (is_minor_in_opt_sector(sector))
        {
            return true;
        }
    ...
    inline bool Chord::iseI_chord(Chord *inverse, int sector) const
    {
        (void)inverse;
    ...
    inline SILENCE_PUBLIC Chord equate<EQUIVALENCE_RELATION_I>(const Chord &chord, double range, double g, int sector)
    {
        ...
        return reflect_in_inversion_flat(chord, sector);
    }

    inline Chord Chord::eI(int sector) const
    {
        return csound::equate<EQUIVALENCE_RELATION_I>(*this, OCTAVE(), 1.0, sector);
    }
    ...
    inline bool Chord::iseRP(double range, int sector) const
    {
        return predicate<EQUIVALENCE_RELATION_RP>(*this, range, 1.0, sector);
    }
    ...
    inline Chord Chord::eRP(double range, int sector) const
    {
        return csound::equate<EQUIVALENCE_RELATION_RP>(*this, range, 1.0, sector);
    }
    ...
    template <>
    inline SILENCE_PUBLIC bool predicate<EQUIVALENCE_RELATION_RT>(const Chord &chord, double range, double g, int sector)
    {
        if (sector >= 0)
        {
    ...
    inline bool Chord::iseRT(double range) const
    {
        return predicate<EQUIVALENCE_RELATION_RT>(*this, range, 1.0, 0);
    }

    template <>
    inline SILENCE_PUBLIC Chord equate<EQUIVALENCE_RELATION_RT>(const Chord &chord, double range, double g, int sector)
    {
        if (sector >= 0)
        {
    ...
    inline Chord Chord::eRT(double range, int sector) const
    {
        return csound::equate<EQUIVALENCE_RELATION_RT>(*this, range, 1.0, sector);
    }
    ...
    inline bool Chord::iseRPT(double range, int sector) const
    {
        return predicate<EQUIVALENCE_RELATION_RPT>(*this, range, 1.0, sector);
    }
    ...
    inline Chord Chord::eRPT(double range, int sector) const
    {
    ...
    inline bool Chord::iseRPTT(double range, double g, int sector) const
    {
    ...
    template <>
    inline SILENCE_PUBLIC bool predicate<EQUIVALENCE_RELATION_RPI>(const Chord &chord, double range, double g, int sector)
    {
        if (sector >= 0)
        {
    ...
    inline bool Chord::iseRPI(double range, int sector) const
    {
        return predicate<EQUIVALENCE_RELATION_RPI>(*this, range, 1.0, sector);
    }

    template <>
    inline SILENCE_PUBLIC Chord equate<EQUIVALENCE_RELATION_RPI>(const Chord &chord, double range, double g, int sector)
    {
        if (sector >= 0)
        {
        ...
        auto consider = [&](const Chord &c)
        {
            if (!predicate<EQUIVALENCE_RELATION_RPI>(c, range, g, sector))
            {
                return;
            }
            if (!found || c < best)
        ...
        Chord a0 = equate<EQUIVALENCE_RELATION_RP>(chord, range, g, sector);
        consider(a0);

        Chord a1 = equate<EQUIVALENCE_RELATION_I>(a0, range, g, sector);
        consider(a1);

        Chord a2 = equate<EQUIVALENCE_RELATION_RP>(a1, range, g, sector);
        consider(a2);

        Chord a3 = equate<EQUIVALENCE_RELATION_I>(a2, range, g, sector);
        consider(a3);

        // Path B: I then RP (plus one repair cycle).
        Chord b0 = equate<EQUIVALENCE_RELATION_I>(chord, range, g, sector);
        consider(b0);

        Chord b1 = equate<EQUIVALENCE_RELATION_RP>(b0, range, g, sector);
        consider(b1);

        Chord b2 = equate<EQUIVALENCE_RELATION_I>(b1, range, g, sector);
        consider(b2);

        Chord b3 = equate<EQUIVALENCE_RELATION_RP>(b2, range, g, sector);
        consider(b3);
        ...
        CHORDSPACE_EQUATE_FAIL("RPI", chord, sector);
        return equate<EQUIVALENCE_RELATION_RP>(chord, range, g, sector);
    }

    inline Chord Chord::eRPI(double range, int sector) const
    {
        return csound::equate<EQUIVALENCE_RELATION_RPI>(*this, range, 1.0, sector);
    }
    ...
    template <>
    inline SILENCE_PUBLIC bool predicate<EQUIVALENCE_RELATION_RPTI>(const Chord &chord, double range, double g, int sector)
    {
        if (sector >= 0)
        {
    ...
    inline bool Chord::iseRPTI(double range, int sector) const
    {
    ...
    inline SILENCE_PUBLIC Chord equate<EQUIVALENCE_RELATION_RPTI>(const Chord &chord, double range, double g, int sector)
    {
        ...
        {
            return predicate<EQUIVALENCE_RELATION_RPTI>(c, range, g, sector);
        };
        ...
        CHORDSPACE_EQUATE_FAIL("RPTI", chord, sector);
        return equate<EQUIVALENCE_RELATION_RPT>(chord, range, g, sector);
    }

    inline Chord Chord::eRPTI(double range, int sector) const
    {
        return csound::equate<EQUIVALENCE_RELATION_RPTI>(*this, range, 1.0, sector);
    }

    //	EQUIVALENCE_RELATION_RPTgI

    template <>
    inline SILENCE_PUBLIC bool predicate<EQUIVALENCE_RELATION_RPTgI>(const Chord &chord, double range, double g, int sector)
    {
        if (sector >= 0)
        {
    ...
    inline bool Chord::iseRPTTI(double range, double g, int sector) const
    {
        return predicate<EQUIVALENCE_RELATION_RPTgI>(*this, range, g, sector);
    }
    ...
    inline SILENCE_PUBLIC Chord equate<EQUIVALENCE_RELATION_RPTgI>(const Chord &chord, double range, double g, int sector)
    {
        ...
        auto satisfies_in_requested = [&](const Chord &c) -> bool
        {
            return predicate<EQUIVALENCE_RELATION_RPTgI>(c, range, g, sector);
        };
        ...
        return equate<EQUIVALENCE_RELATION_RPTg>(chord, range, g, sector);
    }

    inline Chord Chord::eRPTTI(double range, double g, int sector) const
    {
        return csound::equate<EQUIVALENCE_RELATION_RPTgI>(*this, range, g, sector);
    }
    ...
    inline std::string print_opti_sectors(const Chord &chord)
    {
        ...
        for (auto sector : opti_sectors)
        {
            snprintf(buffer, sizeof(buffer), "[opt:%2d  opti:%2d]", sector / 2, sector);
    ...
    inline const char *print_chord(const Chord &chord)
    {
        ...
        for (auto sector : opti_sectors)
        {
            std::snprintf(buffer + std::strlen(buffer), sizeof(buffer), "[OPT %2d  OPTI %2d]  ", sector / 2, sector);
        }
        return buffer;
    }
    ...
    inline std::string Chord::information_sector(int opt_sector_) const
    {
        ...
        if (opt_sector_ == -1)
        {
            sector = opt_domain_sectors().front();
        }
        ...
        result.append(buffer);
        snprintf(buffer, sizeof(buffer), "OPT:         %3d => %s\n", iseOPT(sector), print_chord(eOPT(sector)));
        result.append(buffer);
        snprintf(buffer, sizeof(buffer), "OPTT:        %3d => %s\n", iseOPTT(1., sector), print_chord(eOPTT(1., sector)));
        result.append(buffer);
        snprintf(buffer, sizeof(buffer), "OPI:         %3d => %s\n", iseOPI(sector), print_chord(eOPI(sector)));
        result.append(buffer);
        snprintf(buffer, sizeof(buffer), "OPTI:        %3d => %s\n", iseOPTI(sector), print_chord(eOPTI(sector)));
        result.append(buffer);
        snprintf(buffer, sizeof(buffer), "OPTTI:       %3d => %s\n", iseOPTTI(1., sector), print_chord(eOPTTI(1., sector)));
        result.append(buffer);
    ...
    inline bool Chord::iseO(int sector) const
    {
        return iseR(OCTAVE(), sector);
    }

    inline Chord Chord::eO(int sector) const
    {
        return eR(OCTAVE());
    }

    inline bool Chord::iseI(int sector) const
    {
        return iseI_chord(nullptr, sector);
    }

    inline bool Chord::iseOP(int sector) const
    {
        return iseRP(OCTAVE(), sector);
    }

    inline Chord Chord::eOP(int sector) const
    {
        return eRP(OCTAVE(), sector);
    }

    inline bool Chord::iseOPT(int sector) const
    {
        return iseRPT(OCTAVE(), sector);
    }

    inline bool Chord::iseOPTT(double g, int sector) const
    {
        return iseRPTT(OCTAVE(), g, sector);
    }

    inline Chord Chord::eOPT(int sector) const
    {
        return eRPT(OCTAVE(), sector);
    }

    inline Chord Chord::eOPTT(double g, int sector) const
    {
        return eRPTT(OCTAVE(), g, sector);
    }

    inline bool Chord::iseOPI(int sector) const
    {
        return iseRPI(OCTAVE(), sector);
    }

    inline Chord Chord::eOPI(int sector) const
    {
        return eRPI(OCTAVE(), sector);
    }

    inline bool Chord::iseOPTI(int sector) const
    {
        return iseRPTI(OCTAVE(), sector);
    }

    inline bool Chord::iseOPTTI(double g, int sector) const
    {
        return iseRPTTI(OCTAVE(), g, sector);
    }

    inline Chord Chord::eOPTI(int sector) const
    {
        return eRPTI(OCTAVE(), sector);
    }

    inline Chord Chord::eOPTTI(double g, int sector) const
    {
        return eRPTTI(OCTAVE(), g, sector);
    }
    ...
    template <int EQUIVALENCE_RELATION>
    inline SILENCE_PUBLIC std::vector<csound::Chord> fundamentalDomainByTransformation(int voiceN, double range, double g, int sector)
    {
    ...
    inline SILENCE_PUBLIC HyperplaneEquation hyperplane_equation_from_singular_value_decomposition(const std::vector<Chord> &points_, bool make_eT)
    {
        ...
        std::cerr << "hyperplane_equation_from_singular_value_decomposition: vectors:" << std::endl
                  << matrix << std::endl;
        matrix.transposeInPlace();
        std::cerr << "hyperplane_equation_from_singular_value_decomposition: vectors transposed:" << std::endl
                  << matrix << std::endl;
        Eigen::JacobiSVD<Matrix, Eigen::FullPivHouseholderQRPreconditioner> svd(matrix, Eigen::ComputeFullU | Eigen::ComputeFullV);
        std::cerr << "hyperplane_equation_from_singular_value_decomposition: U:" << std::endl
                  << svd.matrixU() << std::endl;
        std::cerr << "hyperplane_equation_from_singular_value_decomposition: singular values:" << std::endl
                  << svd.singularValues() << std::endl;
        std::cerr << "hyperplane_equation_from_singular_value_decomposition: V:" << std::endl
        ...
        std::cerr << "hyperplane_equation_from_singular_value_decomposition: norm:" << std::endl
                  << norm << std::endl;
        ...
        std::cerr << "hyperplane_equation_from_singular_value_decomposition: unit normal vector: " << std::endl
                  << hyperplane_equation_.unit_normal_vector << std::endl;
        std::cerr << "hyperplane_equation_from_singular_value_decomposition: constant term: " << std::endl
                  << hyperplane_equation_.constant_term << std::endl;
    ...
    inline SILENCE_PUBLIC HyperplaneEquation hyperplane_equation_from_random_inversion_flat(int dimensions, bool transpositional_equivalence, int sector)
    {
    ...
    template <int EQUIVALENCE_RELATION>
    inline SILENCE_PUBLIC bool predicate(const Chord &chord, double range, int sector)
    {
    ...
    template <int EQUIVALENCE_RELATION>
    inline SILENCE_PUBLIC bool predicate(const Chord &chord, double range)
    {
        bool result = predicate<EQUIVALENCE_RELATION>(chord, range, 1.0);
        return result;
    }
    ...
    template <int EQUIVALENCE_RELATION>
    inline SILENCE_PUBLIC bool predicate(const Chord &chord)
    {
    ...
    template <int EQUIVALENCE_RELATION>
    inline SILENCE_PUBLIC Chord equate(const Chord &chord, double range)
    {
        return equate<EQUIVALENCE_RELATION>(chord, range, 1.0);
    }

    template <int EQUIVALENCE_RELATION>
    inline SILENCE_PUBLIC Chord equate(const Chord &chord)
    {
    ...
    inline SILENCE_PUBLIC Chord reflect_in_inversion_flat(const Chord &chord, int sector)
    {
        // Preserve non-pitch data in the chord.
        Chord result = chord;
        int dimensions = chord.voices();
        HyperplaneEquation hyperplane = chord.hyperplane_equation(sector);
    ...
    inline SILENCE_PUBLIC void Scale::conform_with_alteration(Event &event, int scale_degree, int voices, int interval, int alteration) const
    {
    ...
    inline SILENCE_PUBLIC void Scale::conform_with_interval(Event &event, int scale_degree, int voices, int interval) const
    {
    ...
    inline HyperplaneEquation Chord::hyperplane_equation(int sector) const
    {
    ...
    inline Chord Chord::eOT(int sector) const
    {
        auto o = eO();
        auto o_t = o.eT();
        return o_t;
    ...
    inline Chord Chord::eOTT(double g, int sector) const
    {
        auto o = eO();
        auto o_tt = o.eTT(g);
        return o_tt;
    ...
    inline Chord Chord::reflect(int sector) const
    {
        auto reflection = reflect_in_inversion_flat(*this, sector);
        return reflection;
    }
    ...
    inline SILENCE_PUBLIC void PITV::list(bool listheader, bool listps, bool listvoicings) const
    {
        ...
        if (listps)
        {
            ...
            for (const auto &entry : PsForIndexes)
            {
                ...
                for (auto sector : opt_sectors)
                {
                    optts_for_sectors.insert({sector, optt.toString()});
                }
                const auto opti_sectors = optti.opti_domain_sectors();
                for (auto sector : opti_sectors)
                {
                    opttis_for_sectors.insert({sector, optti.toString()});
                }
