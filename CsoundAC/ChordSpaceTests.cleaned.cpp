/*
 * ChordSpaceTests.cleaned.cpp — curated copy of ChordSpaceTests.cpp.
 *
 * Removes the obsolete RPTIg hyperplane diagnostic, duplicate calls, manual
 * API smoke tests superseded by structured tests, and CQT catalogue comparison
 * data (counts differ by convention; see CHORDSPACE.md).
 */
